                ...
                (+ j8_x 
                    (* l9 
                        (+ 
                            (- 
                                (*
                                    (* (cos (- 0 j2_angle))(sin (j8_angle)))
                                    (sin (j9_angle))
                                )
                                (*
                                    (* (sin (- 0 j2_angle))(cos (- 0 j7_angle)))
                                    (* (cos (j8_angle))(sin (j9_angle)))
                                )
                            )
                            (*
                                (* (sin (- 0 j2_angle))(sin (- 0 j7_angle)))
                                (cos (j9_angle))
                            )
                        )
                    )
                ...
                (+ j8_y 
                    (* l9 
                        (- 
                            (+ 
                                (*
                                    (* (sin (- 0 j2_angle))(sin (j8_angle)))
                                    (sin (j9_angle))
                                )
                                (*
                                    (* (cos (- 0 j2_angle))(cos (- 0 j7_angle)))
                                    (* (cos (j8_angle))(sin (j9_angle)))
                                )
                            )
                            (*
                                (* (cos (- 0 j2_angle))(sin (- 0 j7_angle)))
                                (cos (j9_angle))
                            )
                        )
                    )
