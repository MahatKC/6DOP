(define
    ...
    (:requirements :durative-actions :fluents :numeric-fluents :duration-inequalities :time :negative-preconditions)
    ...
    ;     :effect (and
    ;         (decrease (j2_angle)(* #t w2))
    ;         (assign (j2_y)(sin ((* #t w2))))
    ;         (assign (j2_x)(cos ((* #t w2))))
    ; )
    ...
    ;     :effect (and
    ;         (decrease (j2_angle) (* #t w2))
    ;         (assign (j2_y)(sin (j2_angle)))
    ;         (assign (j2_x)(cos (j2_angle)))
    ; )
    

    (:action move_j2_clockwise
        :parameters ()
        :precondition (and (no_movement)(not (head_hit)))
        :effect (and 
            (not (no_movement))
            (joint_2_moving_clockwise)
        )
    ...
    (:action stop_j2_counterclockwise
        :parameters ()
        :precondition (and
            (joint_2_moving_counterclockwise)
            (not (no_movement))
