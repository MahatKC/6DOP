(define
    ...
    ;---------------------------------- J8 --------------------------------------------------------
    (:action move_j8_clockwise
        :parameters ()
        :precondition (and 
            (no_movement)
            (not (joint_8_moving))
            (not (joint_8_finished))
            (joint_7_finished)
        )
        :effect (and 
            (joint_8_moving)
    ...
    (:action move_j8_counterclockwise
        :parameters ()
        :precondition (and 
            (no_movement)
            (not (joint_8_moving))
    ...
    (:process moving_j8_counterclockwise
        :parameters ()
        :precondition (and
            (joint_8_moving)
            (joint_8_moving_counterclockwise)
    ...
    (:event update_positions_j8_moving
        :parameters ()
        :precondition (and
            (joint_8_moving)
            (= updating_positions 1.0)
        ...
        :effect (and
            ...
            (assign (j8_x) 
                (+ j7_x 
                    (* l8 
                        (- 
                            (* (cos (j8_angle))(cos (- 0 (+ j2_angle 1.57))))
                            (*  
            ...
            (assign (j8_y) 
                (+ j7_y 
                    (* l8 
                        (+ 
                            (* (cos (j8_angle))(sin (- 0 (+ j2_angle 1.57))))
                            (*  
                                (* (cos (- 0 j7_angle))(sin (j8_angle)))
                                (cos (- 0 (+ j2_angle 1.57)))
                            )
    ...
    (:action stop_j8
        ...
        :effect (and 
            (not (joint_8_moving))
            (not (joint_8_moving_clockwise))
            (not (joint_8_moving_counterclockwise))
            (no_movement)
            (joint_8_finished)
        )
    )
    ...
    ;---------------------------------- J9 --------------------------------------------------------
    (:action move_j9_clockwise
        :parameters ()
        :precondition (and 
            (no_movement)
            (not (joint_9_moving))
            (not (joint_9_finished))
            (joint_8_finished)
        )
        :effect (and 
            (joint_9_moving)
    ...
    (:action move_j9_counterclockwise
        :parameters ()
        :precondition (and 
            (no_movement)
            (not (joint_9_moving))
    ...
    (:process moving_j9_counterclockwise
        :parameters ()
        :precondition (and
            (joint_9_moving)
            (joint_9_moving_counterclockwise)
    ...
    (:event update_positions_j9_moving
        :parameters ()
        :precondition (and
            (joint_9_moving)
            (= updating_positions 1.0)
                ...
                (+ j8_x 
                    (* l9 
                        (+ 
                            (- 
                                (*
                                    (* (cos (- 0 (+ j2_angle 1.57)))(sin (j8_angle)))
                                    (sin (j9_angle))
                                )
                                (*
                                    (* (sin (- 0 (+ j2_angle 1.57)))(cos (- 0 j7_angle)))
                                    (* (cos (j8_angle))(sin (j9_angle)))
                                )
                            )
                            (*
                                (* (sin (- 0 (+ j2_angle 1.57)))(sin (- 0 j7_angle)))
                                (cos (j9_angle))
                            )
                        )
                    )
                ...
                (+ j8_y 
                    (* l9 
                        (- 
                            (+ 
                                (*
                                    (* (sin (- 0 (+ j2_angle 1.57)))(sin (j8_angle)))
                                    (sin (j9_angle))
                                )
                                (*
                                    (* (cos (- 0 (+ j2_angle 1.57)))(cos (- 0 j7_angle)))
                                    (* (cos (j8_angle))(sin (j9_angle)))
                                )
                            )
                            (*
                                (* (cos (- 0 (+ j2_angle 1.57)))(sin (- 0 j7_angle)))
                                (cos (j9_angle))
                            )
                        )
                    )
            ...
            (assign (j9_z)
                (+ j8_z
                    (* l9
                        (+
                            (*
                                (* (sin (- 0 j7_angle))(cos (j8_angle)))
                                (sin (j9_angle))
                            )
                            (* (cos (j7_angle))(cos (j9_angle)))
                        )
                    )
                )
            )
    ...
    (:action stop_j9
        ...
        :effect (and 
            (not (joint_9_moving))
            (not (joint_9_moving_clockwise))
            (not (joint_9_moving_counterclockwise))
            (no_movement)
            (joint_9_finished)
        )
    )
